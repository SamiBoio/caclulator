...
class Button(CTkButton):
    def __init__(self, parent, text, func, col, row, font, span = 1, color = 'dark_gray'):
        super().__init__(
            master = parent,
            command = func,
            text = text,
...
class NumButton(Button):
    def __init__(self, parent, text, func, col, row, font, span, color = 'light_gray'):
        super().__init__(
            parent = parent,
            text = text,
...
class ImageButton(CTkButton):
    def __init__(self, parent, func, col, row, image, text = '', color = 'dark_gray' ):
        super().__init__(
            master = parent,
            command = func,
            text = text,
